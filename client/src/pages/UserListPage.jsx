          ...
          <div className="">
            {userList?.map((user) => {
              return (
                <div
                  key={user._id}
                  className="grid grid-cols-12 gap-4 items-center text-center py-7 bg-white nth-[2]:bg-gray-100 nth-[2]:hover:bg-gray-200 hover:bg-gray-200 cursor-pointer transition-all duration-300 ease-in-out"
                >
